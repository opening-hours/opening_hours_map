...
OpenLayers.Layer.PopupMarker = OpenLayers.Class(OpenLayers.Layer.Markers,{
	...
	jsonpRequest: function (url, scope, callback) {
		...
		var requestId = "JSONP" + window.callbackCounter;

		//----------------------------------------------------
		//	attach jsonp callback handler
		//----------------------------------------------------

		var closureScope = scope;
		...
		window.callbacks[requestId] = function (data) {
			...
			closureLayer.events.triggerEvent('loadend');
